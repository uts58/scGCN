...
def process_chromosome(ch):
    graph_dir = f'/mmfs1/scratch/utsha.saha/mouse_data/data/datasets/liu_chen_GSE223917_brain_embryo/graphs/brain_without_common_graph/_{ch}'
    model_dir = f"/mmfs1/scratch/utsha.saha/mouse_data/data/datasets/liu_chen_GSE223917_brain_embryo/models/brain/{ch}_no_features_1000.pt"
...
df.to_csv(f"brain_hic.csv", index=False)
