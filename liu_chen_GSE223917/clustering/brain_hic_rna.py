...
def process_chromosome(ch):
    ...
    model_dir = f"/mmfs1/scratch/utsha.saha/mouse_data/data/datasets/liu_chen_GSE223917_brain_embryo/models/brain/{ch}_1000.pt"
...
df.to_csv(f"brain_hic_rna.csv", index=False)
